...
FACTION.name = "White Glove Society"
FACTION.description = "The most civilised people on the Strip, and nobody asks what is on the menu."
FACTION.color = Color(235, 235, 235)
...
FACTION.icon = "phoenix/faction_icons/paradise.png"

FACTION_WHITEGLOVE = FACTION.index
