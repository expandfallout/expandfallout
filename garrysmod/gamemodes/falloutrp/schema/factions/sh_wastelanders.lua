...
FACTION.description = "Unaffiliated survivors, getting by on grit and whatever they can carry."
FACTION.color = Color(150, 130, 100)
...
FACTION.icon = "phoenix/faction_icons/wastelander.png"
