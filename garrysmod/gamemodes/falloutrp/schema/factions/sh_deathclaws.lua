...
FACTION.name = "Deathclaws"
FACTION.description = "Mutated lizards. Extremely aggressive, and extremely fast."
...
FACTION.icon = "phoenix/faction_icons/creature.png"

FACTION_DEATHCLAWS = FACTION.index
