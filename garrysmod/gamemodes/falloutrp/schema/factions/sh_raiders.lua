...
FACTION.name = "Raiders"
FACTION.description = "No cause, no territory worth the name, and twenty-four sets of spiked armour between them."
FACTION.color = Color(140, 40, 40)
...
FACTION.icon = "phoenix/faction_icons/jackals.png"
