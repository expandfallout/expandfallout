...
FACTION.name = "Super Mutants"
FACTION.description = "Dipped in FEV and come out enormous. Some of them are still in there."
...
FACTION.icon = "phoenix/faction_icons/supermutant.png"
