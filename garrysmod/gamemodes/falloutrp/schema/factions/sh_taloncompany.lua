...
FACTION.description = "Mercenaries out of the Capital Wasteland who take contracts nobody admits to writing."
FACTION.color = Color(110, 90, 70)
...
FACTION.icon = "phoenix/faction_icons/talon.png"

FACTION_TALONCOMPANY = FACTION.index
