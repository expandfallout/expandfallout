...
FACTION.name = "Chairmen"
FACTION.description = "The Tops. Sharp suits, sharper knives, and a great deal of charm."
FACTION.color = Color(90, 60, 140)
...
FACTION.icon = "phoenix/faction_icons/sierra.png"

FACTION_CHAIRMEN = FACTION.index
