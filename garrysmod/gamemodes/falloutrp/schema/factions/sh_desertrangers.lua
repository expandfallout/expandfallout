...
FACTION.description = "Survivalists out of the Mojave, older than the Republic and less interested in it than it would like."
...
FACTION.icon = "phoenix/faction_icons/desertrangers.png"
