...
FACTION.name = "Shi"
FACTION.description = "Descendants of a Chinese submarine crew, and the most advanced chemistry on the west coast."
...
FACTION.icon = "phoenix/faction_icons/shi.png"
