...
FACTION.description = "A slaver empire holding order through conquest, fear and absolute obedience."
FACTION.color = Color(193, 0, 0)
...
FACTION.icon = "phoenix/faction_icons/legion.png"
