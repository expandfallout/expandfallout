...
FACTION.name = "ZSD-7"
FACTION.description = "Zetan Survey Detachment 7. Sent ahead of the invasion force to work out whether one is needed."
FACTION.color = Color(0, 255, 255)
FACTION.isDefault = false

--[[
	Not a person. Marked so the spawn system and anything else
	that assumes a human character can tell the difference.
]]
FACTION.isCreature = true
...
FACTION.icon = "phoenix/faction_icons/zeta.png"

FACTION_ZETAN = FACTION.index
