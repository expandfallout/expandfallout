...
FACTION.name = "Railroad"
FACTION.description = "A cell network smuggling synths out of the Institute, at a cost they do not discuss."
FACTION.color = Color(200, 60, 60)
...
FACTION_RAILROAD = FACTION.index
