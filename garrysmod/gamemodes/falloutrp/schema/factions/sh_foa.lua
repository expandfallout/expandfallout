...
FACTION.name = "Followers of the Apocalypse"
FACTION.description = "Doctors and teachers who believe knowledge is worth more shared than hoarded. Not everyone agrees."
...
FACTION.icon = "phoenix/faction_icons/foa.png"

FACTION_FOA = FACTION.index
