...
FACTION.name = "Unity Remnants"
FACTION.description = "The Master's army, still marching for a cause that ended decades ago."
...
FACTION.icon = "phoenix/faction_icons/unity.png"
