...
FACTION.name = "The Outcasts"
FACTION.description = "A Brotherhood splinter intent on unifying the Brotherhood under their own reading of the Codex."
FACTION.color = Color(168, 35, 20)
...
FACTION.icon = "phoenix/faction_icons/outcast.png"

FACTION_OUTCASTS = FACTION.index
