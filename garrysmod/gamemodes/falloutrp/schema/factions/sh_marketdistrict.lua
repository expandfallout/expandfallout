...
FACTION.name = "Market District"
FACTION.description = "Merchants who decided there was more safety in one market than in twenty stalls."
...
FACTION.icon = "phoenix/faction_icons/goodneighbor.png"

FACTION_MARKETDISTRICT = FACTION.index
