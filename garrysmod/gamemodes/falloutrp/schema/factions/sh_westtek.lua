...
FACTION.name = "Happy Trails Caravan Company"
FACTION.description = "A caravan company operating out of Utah, with a pre-War name it did not choose."
...
FACTION.icon = "phoenix/faction_icons/westtek.png"

FACTION_WESTTEK = FACTION.index
