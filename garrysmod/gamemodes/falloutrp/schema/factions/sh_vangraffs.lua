...
FACTION.description = "Energy weapons merchants, and ruthless about the competition."
...
FACTION.icon = "phoenix/faction_icons/outlaws.png"

FACTION_VANGRAFFS = FACTION.index
