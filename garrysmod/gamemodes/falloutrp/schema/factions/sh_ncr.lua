...
FACTION.description = "A democratic republic rebuilding civilisation through law, expansion and a very stretched army."
FACTION.color = Color(193, 154, 107)
...
FACTION.icon = "phoenix/faction_icons/ncr.png"
