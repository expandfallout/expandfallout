...
FACTION.name = "Chimera"
FACTION.description = "Humans remade by spore carriers. What is left is not quite either."
...
FACTION.icon = "phoenix/faction_icons/chimera.png"

FACTION_CHIMERA = FACTION.index
