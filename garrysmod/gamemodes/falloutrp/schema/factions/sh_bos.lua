...
FACTION.description = "A technocratic military order hoarding pre-War technology to prevent another apocalypse."
FACTION.color = Color(0, 0, 225)
...
FACTION.icon = "phoenix/faction_icons/bos.png"
