...
FACTION.name = "Children of Atom"
FACTION.description = "They do not fear radiation. They are waiting inside it for the Division."
FACTION.color = Color(120, 200, 90)
...
FACTION.icon = "phoenix/faction_icons/cotc.png"

FACTION_CHILDRENOFATOM = FACTION.index
