...
FACTION.description = "Vault dwellers who took an airfield and shell anything that approaches it."
FACTION.color = Color(200, 90, 40)
...
FACTION.icon = "phoenix/faction_icons/vault_34.png"
