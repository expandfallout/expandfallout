...
FACTION.name = "Minutemen"
FACTION.description = "A militia that answers when somebody calls, which is rarer than it sounds."
FACTION.color = Color(27, 167, 222)
...
FACTION.icon = "phoenix/faction_icons/minutemen.png"

FACTION_MINUTEMEN = FACTION.index
