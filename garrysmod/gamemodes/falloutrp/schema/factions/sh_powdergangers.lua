...
FACTION.name = "Powder Gangers"
FACTION.description = "Escaped convicts from the NCRCF, armed with the dynamite they were sentenced to lay."
FACTION.color = Color(180, 140, 60)
...
FACTION_POWDERGANGERS = FACTION.index
