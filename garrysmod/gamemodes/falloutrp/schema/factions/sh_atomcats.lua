...
FACTION.name = "Atom Cats"
FACTION.description = "Power armour mechanics with a garage, a look, and absolutely no interest in anybody's war."
FACTION.color = Color(230, 120, 40)
...
FACTION.icon = "phoenix/faction_icons/robco.png"

FACTION_ATOMCATS = FACTION.index
