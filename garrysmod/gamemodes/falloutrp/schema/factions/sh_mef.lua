--[[
	Midwestern Expeditionary Force.

	GENERATED FILE. The roster is `_docs/tools/factions.py`; edit it
	there and run `_docs/tools/genfactions.py`.
]]

FACTION.name = "Midwestern Expeditionary Force"
FACTION.description = "A Brotherhood detachment sent out of Maxson's founding chapter, and out of contact for a very long time."
FACTION.color = Color(255, 222, 40)
...
FACTION.icon = "phoenix/faction_icons/mef.png"

FACTION_MEF = FACTION.index
