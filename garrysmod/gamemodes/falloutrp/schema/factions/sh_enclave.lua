...
FACTION.description = "What is left of the United States government, still convinced it is the United States government."
...
FACTION.icon = "phoenix/faction_icons/enclave.png"
