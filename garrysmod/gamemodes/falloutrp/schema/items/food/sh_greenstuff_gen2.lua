ITEM.name = "F.E.V (GEN 2)"

ITEM.description = "A vial of the Forced Evolutionary Virus, second generation. Drinking this substance is rumored to induce mutations."
ITEM.category = "Food"
