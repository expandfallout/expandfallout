ITEM.name = "Nuka-Cola Classic"
ITEM.description = "A clear bottle containing dark brown liquid with the classic Nuka-Cola label."
ITEM.category = "Food"
...
ITEM.eatMeText = "gulps down a glass of Nuka-Cola Classic."
