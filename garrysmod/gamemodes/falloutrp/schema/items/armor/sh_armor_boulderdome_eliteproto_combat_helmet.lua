ITEM.name = "Elite Proto-Combat Helmet"
ITEM.description = "A next generation prototype combat helmet, developed in use for covert operations by the U.S. Military pre-war. The helmet has been heavily reinforced and given military grade air filtration."
