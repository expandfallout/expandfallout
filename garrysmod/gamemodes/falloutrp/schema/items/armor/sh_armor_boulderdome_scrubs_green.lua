ITEM.name = "Boulder Dome Green Scrubs"
...
ITEM.textureReplace = {
    ["roadkill/fallout/player/male/clothing/scientistscrubs/scientist_scrubs"] = "roadkill/fallout/player/male/clothing/scientistscrubs/scientist_scrubs_g",
}
