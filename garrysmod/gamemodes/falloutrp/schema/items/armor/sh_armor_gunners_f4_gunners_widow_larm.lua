ITEM.name = "Gunners Widow Left Arm"
...
ITEM.femaleModel = "models/widowz/fallout/player/faction/gunners/widgunnerlarm.mdl"
ITEM.maleModel = "models/widowz/fallout/player/faction/gunners/widgunnerlarm.mdl"
