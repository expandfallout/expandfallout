ITEM.name = "Gunners Widow Right Leg"
...
ITEM.femaleModel = "models/widowz/fallout/player/faction/gunners/widgunnerrleg.mdl"
ITEM.maleModel = "models/widowz/fallout/player/faction/gunners/widgunnerrleg.mdl"
