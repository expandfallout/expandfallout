--[[
	Blueprint Vendor Schematics.

	GENERATED FILE. The roster is `_docs/tools/materials.py`;
	edit it there and run `_docs/tools/genmaterials.py`.
]]

ITEM.name = "Blueprint Vendor Schematics"
ITEM.description = "Obtain and submit this AND the Building Framework to the *upper skygods* to have these items redeemed."
ITEM.model = "models/mosi/fallout4/props/junk/folder.mdl"
