...
ITEM.name = "Snow Globe - Mt. Charleston"
ITEM.description = "A Pre-War artifact, a Snow Globe with a miniature of Mt. Charleston inside."
ITEM.model = "models/models/fallout/snowglobe_mtcharleston.mdl"
ITEM.category = "Valuables"
