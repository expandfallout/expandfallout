...
ITEM.name = "This Machine"
ITEM.description = "This Machine."
ITEM.category = "Weapons"

ITEM.model = "models/catmop/fallout/weapons/world/rifle/w_thismachine.mdl"
ITEM.class = "ls_unique_thismachine"
