--[[
	...
	`.lua` suffix - `charisma`, lowercase. Phoenix stores attributes under the
...
ATTRIBUTE.description = "Presence and persuasion. Improves prices you are offered and pay you receive."
