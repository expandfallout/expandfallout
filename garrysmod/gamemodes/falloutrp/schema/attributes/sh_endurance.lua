--[[
	...
	`.lua` suffix - `endurance`, lowercase. Phoenix stores attributes under the
...
ATTRIBUTE.description = "Stamina and toughness. Raises your maximum health and how long you can exert yourself."
