--[[
	...
	`.lua` suffix - `agility`, lowercase. Phoenix stores attributes under the
...
ATTRIBUTE.description = "Speed and coordination. Increases movement speed and how quickly you draw a weapon."
