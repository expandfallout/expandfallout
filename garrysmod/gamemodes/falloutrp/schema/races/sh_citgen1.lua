--[[
	...
	GENERATED from Phoenix's `libs/races/cit/sh_race_citgen1.lua`.
...
RACE.name = "Generation 1 Synth"
RACE.class = "citgen1"
RACE.description = "A C.I.T Generation 1 Synth, designed to not look and act like a human."
...
RACE.defaultModels = {
    male = "models/mosi/fallout4/player/synth_gen_1.mdl",
    female = "models/mosi/fallout4/player/synth_gen_1.mdl"
}
RACE.skins = {
    male = {
        synth = 0
