--[[
	...
	GENERATED from Phoenix's `libs/races/supermutants/sh_race_centaur_evolved.lua`.
...
RACE.name = "Centaur Evolved"
RACE.class = "centaur_evolved"
RACE.description = ""
RACE.defaultFaction = ""
RACE.animationModel = "models/fallout/centaur_evolved.mdl"
RACE.hideBody = true
RACE.genders = {
    male = true,
    female = false
...
RACE.defaultModels = {
    male = "models/fallout/centaur_evolved.mdl",
    female = "models/fallout/centaur_evolved.mdl"
}
RACE.skins = {
    male = {
        default = 0
...
RACE.spawnMessage = {
    Color(255,255,255), "You are a ", Color(0,255,0), "Evolved Centaur", Color(255,255,255), ".\n",
    "You are ", Color(255,0,0), "KOS.",Color(255,255,255), " You must attack other players on sight, unless you are a unity controlled Evolved Centaur.\n\n",
...
ix.anim.SetModelClass("models/fallout/centaur_evolved.mdl", "centaur")
