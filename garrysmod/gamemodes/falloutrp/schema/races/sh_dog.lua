--[[
	...
	GENERATED from Phoenix's `libs/races/dogs/sh_race_dog.lua`.
...
RACE.description = ""
RACE.defaultFaction = ""
RACE.animationModel = "models/fallout/dogskin.mdl"
RACE.hideBody = true
RACE.genders = {
    male = true,
    female = true
...
RACE.defaultModels = {
    male = "models/fallout/dogskin.mdl",
    female = "models/fallout/dogskin.mdl"
}
RACE.skins = {
    male = {
        default = 1
