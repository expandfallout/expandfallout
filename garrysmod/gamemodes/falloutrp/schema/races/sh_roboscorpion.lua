--[[
	...
	GENERATED from Phoenix's `libs/races/robots/sh_race_roboscorpion.lua`.
...
RACE.name = "Roboscorpion"
RACE.class = "roboscorpion"
RACE.description = ""
RACE.defaultFaction = ""
RACE.animationModel = "models/fallout/roboscorpion.mdl"
RACE.hideBody = true
RACE.genders = {
    male = true,
    female = true
...
RACE.defaultModels = {
    male = "models/fallout/roboscorpion.mdl",
    female = "models/fallout/roboscorpion.mdl"
}
RACE.skins = {
    male = {
        default = 0
...
RACE.viewOffset = {
    normal = Vector(0,0,40),
    ducked = Vector(0,0,40)
}
RACE.hull = {
    normal = Vector(16,16,45),
    ducked = Vector(16,16,45)
}
RACE.raceColor = Color(5, 92, 5)
RACE.editorAnimation = "mtidle"
RACE.spawnMessage = {
    Color(255,255,255), "You are a ", Color(255,0,0), "Radscorpion", Color(255,255,255), ".\n",
...
ix.anim.SetModelClass("models/fallout/roboscorpion.mdl", "radscorpion")
