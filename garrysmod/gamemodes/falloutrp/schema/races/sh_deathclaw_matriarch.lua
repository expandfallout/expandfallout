--[[
	...
	GENERATED from Phoenix's `libs/races/deathclaws/sh_race_deathclaw_matriarch.lua`.
...
RACE.name = "Deathclaw Matriarch"
RACE.class = "deathclaw_matriarch"
RACE.description = ""
RACE.defaultFaction = ""
RACE.animationModel = "models/fallout/deathclaw_mother.mdl"
RACE.hideBody = true
RACE.genders = {
    male = true,
    female = false
...
RACE.defaultModels = {
    male = "models/fallout/deathclaw_mother.mdl",
    female = "models/fallout/deathclaw_mother.mdl"
}
RACE.skins = {
    male = {
        default = 0
...
ix.anim.SetModelClass("models/fallout/deathclaw_mother.mdl", "deathclaw")
