--[[
	...
	GENERATED from Phoenix's `libs/races/radscorpions/sh_race_radscorpion_glowing.lua`.
...
RACE.name = "Glowing Radscorpion"
RACE.class = "radscorpion_glowing"
RACE.description = ""
RACE.defaultFaction = ""
...
RACE.spawnMessage = {
    Color(255,255,255), "You are a ", Color(255,0,0), "Glowing Radscorpion", Color(255,255,255), ".\n",
...
ix.anim.SetModelClass("models/fallout/radscorpion.mdl", "radscorpion")
