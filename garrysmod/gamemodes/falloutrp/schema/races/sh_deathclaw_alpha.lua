--[[
	...
	GENERATED from Phoenix's `libs/races/deathclaws/sh_race_deathclaw_alpha.lua`.
...
RACE.name = "Deathclaw Alpha"
RACE.class = "deathclaw_alpha"
RACE.description = ""
RACE.defaultFaction = ""
RACE.animationModel = "models/fallout/deathclaw_alphamale.mdl"
RACE.hideBody = true
RACE.genders = {
    male = true,
    female = false
...
RACE.defaultModels = {
    male = "models/fallout/deathclaw_alphamale.mdl",
    female = "models/fallout/deathclaw_alphamale.mdl"
}
RACE.skins = {
    male = {
        default = 0
...
ix.anim.SetModelClass("models/fallout/deathclaw_alphamale.mdl", "deathclaw")
