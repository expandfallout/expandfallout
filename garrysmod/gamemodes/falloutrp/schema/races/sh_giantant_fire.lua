--[[
	...
	GENERATED from Phoenix's `libs/races/ants/sh_race_giantant_fire.lua`.
...
RACE.name = "Giant Fire Ant"
RACE.class = "giantant_fire"
RACE.description = ""
RACE.defaultFaction = ""
