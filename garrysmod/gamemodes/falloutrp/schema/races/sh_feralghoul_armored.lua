--[[
	...
	GENERATED from Phoenix's `libs/races/ghouls/sh_race_feralghoul_armored.lua`.
...
RACE.name = "Armored Feral Ghoul"
RACE.class = "feralghoul_armored"
RACE.description = ""
RACE.defaultFaction = ""
RACE.animationModel = "models/fallout/ghoularmored.mdl"
RACE.hideBody = true
RACE.genders = {
    male = true,
    female = true
...
RACE.defaultModels = {
    male = "models/fallout/ghoularmored.mdl",
    female = "models/fallout/ghoularmored.mdl"
}
RACE.skins = {
    male = {
        default = 3
...
RACE.spawnMessage = {
    Color(255,255,255), "You are a ", Color(255,0,0), "Armored Feral Ghoul", Color(255,255,255), ".\n",
...
ix.anim.SetModelClass("models/fallout/ghoularmored.mdl", "feralghoul")
