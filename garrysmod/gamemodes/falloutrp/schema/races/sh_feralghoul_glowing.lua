--[[
	...
	GENERATED from Phoenix's `libs/races/ghouls/sh_race_feralghoul_glowing.lua`.
...
RACE.name = "Glowing One"
RACE.class = "feralghoul_glowing"
RACE.description = ""
RACE.defaultFaction = ""
...
RACE.spawnMessage = {
    Color(255,255,255), "You are a ", Color(255,0,0), "Glowing One", Color(255,255,255), ".\n",
