--[[
	...
	GENERATED from Phoenix's `libs/races/radscorpions/sh_race_radscorpion_nuka.lua`.
...
RACE.name = "Nuka Radscorpion"
RACE.class = "radscorpion_nuka"
RACE.description = ""
RACE.defaultFaction = ""
...
RACE.spawnMessage = {
    Color(255,255,255), "You are a ", Color(255,0,0), "Nuka Radscorpion", Color(255,255,255), ".\n",
