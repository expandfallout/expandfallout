--[[
	...
	GENERATED from Phoenix's `libs/races/supermutants/sh_race_behemoth_unity.lua`.
	...
	4 of 5 models are not installed and are filtered at load.
]]

RACE.name = "Unity Behemoth"
RACE.class = "behemoth_unity"
RACE.description = ""
RACE.defaultFaction = ""
...
RACE.defaultModels = {
    male = "models/widowz/fallout/player/mutant/76Beh.mdl",
    female = "models/widowz/fallout/player/mutant/76Beh.mdl"
}
RACE.skins = {
    male = {
        default = 0
