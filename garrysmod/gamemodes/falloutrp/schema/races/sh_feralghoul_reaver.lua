--[[
	...
	GENERATED from Phoenix's `libs/races/ghouls/sh_race_feralghoul_reaver.lua`.
...
RACE.name = "Feral Ghoul Reaver"
RACE.class = "feralghoul_reaver"
RACE.description = ""
RACE.defaultFaction = ""
RACE.animationModel = "models/fallout/ghoulreaver.mdl"
RACE.hideBody = true
RACE.genders = {
    male = true,
    female = true
...
RACE.defaultModels = {
    male = "models/fallout/ghoulreaver.mdl",
    female = "models/fallout/ghoulreaver.mdl"
}
RACE.skins = {
    male = {
        default = 0
...
RACE.spawnMessage = {
    Color(255,255,255), "You are a ", Color(255,0,0), "Feral Ghoul Reaver", Color(255,255,255), ".\n",
    "You are ", Color(255,0,0), "KOS.",Color(255,255,255),
    Color(255,255,0), "\n\nRaise your Fists to preform attacks.\n",
    Color(255,255,255), "[Mouse 1] - Melee Attack.\n[Mouse 2] - Angry Sounds.[R] - Throw Gore Grenade."
}
...
ix.anim.SetModelClass("models/fallout/ghoulreaver.mdl", "feralghoul")
