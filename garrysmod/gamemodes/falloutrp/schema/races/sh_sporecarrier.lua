--[[
	...
	GENERATED from Phoenix's `libs/races/creatures/sh_race_sporecarrier.lua`.
...
RACE.name = "Spore Carrier"
RACE.class = "sporecarrier"
RACE.description = ""
RACE.defaultFaction = ""
RACE.animationModel = "models/fallout/sporecarrier.mdl"
RACE.hideBody = true
RACE.genders = {
    male = true,
    female = true
...
RACE.defaultModels = {
    male = "models/fallout/sporecarrier.mdl",
    female = "models/fallout/sporecarrier.mdl"
}
RACE.skins = {
    male = {
        default = 0
...
RACE.spawnMessage = {
    Color(255,255,255), "You are a ", Color(255,0,0), "Spore Carrier", Color(255,255,255), ".\n",
    "You are ", Color(255,0,0), "KOS.",Color(255,255,255), " You must attack other players on sight, unless you are a chimera controlled Spore Carrier.\n\n",
...
ix.anim.SetModelClass("models/fallout/sporecarrier.mdl", "sporecarrier")
