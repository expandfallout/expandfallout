...
CLASS.name = "FoA - Officer"
CLASS.description = "Senior enough in the Followers of the Apocalypse for an order to carry."
CLASS.faction = FACTION_FOA
