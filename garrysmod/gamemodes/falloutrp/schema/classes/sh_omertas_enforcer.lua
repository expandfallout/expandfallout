...
CLASS.name = "Omertas - Enforcer"
CLASS.description = "Answers for the rank and file of the Omertas."
CLASS.faction = FACTION_OMERTAS
...
CLASS_OMERTAS_ENFORCER = CLASS.index
