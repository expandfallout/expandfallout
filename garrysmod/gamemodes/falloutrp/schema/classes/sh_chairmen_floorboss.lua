...
CLASS.name = "Chairmen - Floor Boss"
CLASS.description = "Senior enough in the Chairmen for an order to carry."
CLASS.faction = FACTION_CHAIRMEN
...
CLASS_CHAIRMEN_FLOORBOSS = CLASS.index
