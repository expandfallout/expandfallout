--[[
	White Glove Society - Maitre d'.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "White Glove Society - Maitre d'"
CLASS.description = "Senior enough in the White Glove Society for an order to carry."
...
CLASS_WHITEGLOVE_MAITRED = CLASS.index
