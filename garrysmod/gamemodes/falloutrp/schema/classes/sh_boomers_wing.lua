--[[
	Boomers - Wing Commander.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "Boomers - Wing Commander"
CLASS.description = "Senior enough in the Boomers for an order to carry."
...
CLASS_BOOMERS_WING = CLASS.index
