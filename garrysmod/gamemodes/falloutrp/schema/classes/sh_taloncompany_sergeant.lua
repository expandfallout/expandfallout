--[[
	Talon Company - Sergeant.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "Talon Company - Sergeant"
CLASS.description = "Answers for the rank and file of the Talon Company."
...
CLASS_TALONCOMPANY_SERGEANT = CLASS.index
