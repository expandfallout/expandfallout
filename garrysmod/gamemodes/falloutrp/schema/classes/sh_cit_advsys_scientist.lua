--[[
	CIT - Advanced Systems Scientist.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "CIT - Advanced Systems Scientist"
CLASS.description = "Answers for the rank and file of the C.I.T.."
...
CLASS_CIT_ADVSYS_SCIENTIST = CLASS.index
