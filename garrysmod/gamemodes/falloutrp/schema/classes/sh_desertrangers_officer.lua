--[[
	Desert Rangers - Officer.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "Desert Rangers - Officer"
CLASS.description = "Senior enough in the Desert Rangers for an order to carry."
...
CLASS_DESERTRANGERS_OFFICER = CLASS.index
