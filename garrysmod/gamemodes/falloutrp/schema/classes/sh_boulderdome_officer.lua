--[[
	Boulder Dome - Officer.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "Boulder Dome - Officer"
CLASS.description = "Senior enough in the Boulder Dome for an order to carry."
CLASS.faction = FACTION_BOULDERDOME
...
CLASS_BOULDERDOME_OFFICER = CLASS.index
