--[[
	Talon Company - Commander.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "Talon Company - Commander"
CLASS.description = "Runs the Talon Company, and answers for it."
...
CLASS_TALONCOMPANY_COMMANDER = CLASS.index
