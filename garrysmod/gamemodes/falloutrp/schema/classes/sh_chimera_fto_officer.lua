...
CLASS.name = "FTO - Officer"
CLASS.description = "Senior enough in the Chimera for an order to carry."
CLASS.faction = FACTION_CHIMERA
...
CLASS_CHIMERA_FTO_OFFICER = CLASS.index
