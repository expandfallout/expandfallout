...
CLASS.name = "Raiders - Veteran"
CLASS.description = "Answers for the rank and file of the Raiders."
CLASS.faction = FACTION_RAIDERS
...
CLASS_RAIDERS_VETERAN = CLASS.index
