--[[
	Crimson Caravan - Enlisted.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "Crimson Caravan - Enlisted"
CLASS.description = "The rank and file of the Market District."
...
CLASS_CCMARKET_ENLISTED = CLASS.index
