...
CLASS.name = "Wasteland Creature"
CLASS.description = "Something the wasteland made that has not been named yet."
CLASS.faction = FACTION_CREATURES
...
CLASS_CREATURE_WILDLIFE = CLASS.index
