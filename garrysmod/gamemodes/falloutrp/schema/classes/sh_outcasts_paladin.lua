...
CLASS.name = "Outcasts - Paladin"
CLASS.description = "Senior enough in the The Outcasts for an order to carry."
CLASS.faction = FACTION_OUTCASTS
...
CLASS_OUTCASTS_PALADIN = CLASS.index
