--[[
	The Kings - Sergeant-at-Arms.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "The Kings - Sergeant-at-Arms"
CLASS.description = "Answers for the rank and file of the The Kings."
...
CLASS_KINGS_SERGEANT = CLASS.index
