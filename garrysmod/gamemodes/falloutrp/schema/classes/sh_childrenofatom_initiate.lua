--[[
	Children of Atom - Initiate.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "Children of Atom - Initiate"
CLASS.description = "The rank and file of the Children of Atom."
...
CLASS_CHILDRENOFATOM_INITIATE = CLASS.index
