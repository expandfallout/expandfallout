...
CLASS.name = "Liberty Prime"
CLASS.description = "Forty feet of Cold War propaganda with a fusion core. Democracy is non-negotiable."
...
CLASS_ROBOT_LIBERTYPRIME = CLASS.index
