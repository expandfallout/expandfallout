--[[
	Powder Gangers - Convict.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "Powder Gangers - Convict"
CLASS.description = "The rank and file of the Powder Gangers."
...
CLASS_POWDERGANGERS_CONVICT = CLASS.index
