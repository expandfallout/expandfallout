...
CLASS.name = "Atom Cats - Mechanic"
CLASS.description = "Answers for the rank and file of the Atom Cats."
CLASS.faction = FACTION_ATOMCATS
...
CLASS_ATOMCATS_MECHANIC = CLASS.index
