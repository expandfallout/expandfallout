--[[
	Powder Gangers - Enforcer.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "Powder Gangers - Enforcer"
CLASS.description = "Answers for the rank and file of the Powder Gangers."
...
CLASS_POWDERGANGERS_ENFORCER = CLASS.index
