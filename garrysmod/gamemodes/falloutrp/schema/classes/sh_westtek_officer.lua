...
CLASS.name = "West Tek - Officer"
CLASS.description = "Senior enough in the Happy Trails Caravan Company for an order to carry."
CLASS.faction = FACTION_WESTTEK
...
CLASS_WESTTEK_OFFICER = CLASS.index
