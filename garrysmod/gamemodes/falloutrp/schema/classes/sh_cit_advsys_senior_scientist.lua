--[[
	CIT - Senior Advanced Systems Scientist.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "CIT - Senior Advanced Systems Scientist"
CLASS.description = "Senior enough in the C.I.T. for an order to carry."
CLASS.faction = FACTION_CIT
...
CLASS_CIT_ADVSYS_SENIOR_SCIENTIST = CLASS.index
