--[[
	CIT - Advanced Systems Division Lead.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "CIT - Advanced Systems Division Lead"
CLASS.description = "Runs the C.I.T., and answers for it."
...
CLASS_CIT_ADVSYS_DIVISION_LEAD = CLASS.index
