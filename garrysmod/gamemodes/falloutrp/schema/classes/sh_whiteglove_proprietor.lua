--[[
	White Glove Society - Proprietor.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "White Glove Society - Proprietor"
CLASS.description = "Runs the White Glove Society, and answers for it."
...
CLASS_WHITEGLOVE_PROPRIETOR = CLASS.index
