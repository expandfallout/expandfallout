...
CLASS.name = "Minutemen - NCO"
CLASS.description = "Answers for the rank and file of the Minutemen."
CLASS.faction = FACTION_MINUTEMEN
...
CLASS_MINUTEMEN_NCO = CLASS.index
