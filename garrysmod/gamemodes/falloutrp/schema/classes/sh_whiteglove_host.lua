--[[
	White Glove Society - Host.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "White Glove Society - Host"
CLASS.description = "Answers for the rank and file of the White Glove Society."
...
CLASS_WHITEGLOVE_HOST = CLASS.index
