--[[
	Crimson Caravan - Officer.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "Crimson Caravan - Officer"
CLASS.description = "Senior enough in the Market District for an order to carry."
CLASS.faction = FACTION_MARKETDISTRICT
...
CLASS_CCMARKET_OFFICER = CLASS.index
