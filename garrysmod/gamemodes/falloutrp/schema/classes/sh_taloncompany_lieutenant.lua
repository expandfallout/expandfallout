--[[
	Talon Company - Lieutenant.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "Talon Company - Lieutenant"
CLASS.description = "Senior enough in the Talon Company for an order to carry."
CLASS.faction = FACTION_TALONCOMPANY
...
CLASS_TALONCOMPANY_LIEUTENANT = CLASS.index
