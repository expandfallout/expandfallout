--[[
	Children of Atom - High Confessor.

	GENERATED FILE. The roster is `_docs/tools/classes.py`; edit
	it there and run `_docs/tools/genclasses.py`.
]]

CLASS.name = "Children of Atom - High Confessor"
CLASS.description = "Runs the Children of Atom, and answers for it."
...
CLASS_CHILDRENOFATOM_HIGHCONFESSOR = CLASS.index
